...
import './AppealsPagePsychologist.css';
...
const AppealsPagePsychologist = () => {
  ...
  const onFinish = async (values) => {
    ...
    try {
      ...
      await axios.post(`${Base_URL}/psychologist/appeals`, dataToSend, {
        headers: {
...
export default AppealsPagePsychologist;
